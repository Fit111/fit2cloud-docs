...
![创建合同](/img/cordys/user_manual/contractcraet2.png)
...
![合同配置](/img/cordys/user_manual/contractseetings2.png)

<div style={{textAlign:"center",color:"#8a8f99",fontSize:"13px",margin:"6px 0 20px"}}>图 3  合同配置</div>
...
<div style={{textAlign:"center",color:"#8a8f99",fontSize:"13px",margin:"6px 0 20px"}}>图 4  合同关联</div>
