...
:::note[在进行升级或者迁移操作前，请先做好备份工作]

:::
:::warning[注意]

- 更新前请一定要做好备份工作
- [V2版本升级至V3版本请参考此文档](https://kb.fit2cloud.com/?p=06638d69-f109-4333-b5bf-65b17b297ed9)
- [数据库迁移请先参考此文档](previous_version_upgrade/mariadb-mysql)
- [升级前版本小于 1.4.4 请先按照此文档操作](previous_version_upgrade/1.0.0-1.4.3)
- [升级前版本小于 1.4.5 请先按照此文档操作](previous_version_upgrade/1.4.4)
- [未使用 installer 部署的用户请参考迁移说明迁移到最新版本](migration)
:::
