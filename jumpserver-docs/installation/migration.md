...
>>> 加载 Docker 镜像
Docker: Pulling from jumpserver/core: 	    [ OK ]
Docker: Pulling from jumpserver/koko: 	    [ OK ]
Docker: Pulling from jumpserver/web:  	    [ OK ]
Docker: Pulling from jumpserver/redis:6-alpine      [ OK ]
Docker: Pulling from jumpserver/mysql:5 	        [ OK ]
Docker: Pulling from jumpserver/lion: 	    [ OK ]
...
>>> 安装完成了
1. 可以使用如下命令启动, 然后访问
cd /root/jumpserver-installer-v4.10.17
./jmsctl.sh start
