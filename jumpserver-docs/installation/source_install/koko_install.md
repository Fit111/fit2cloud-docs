...
| OS     | Arch    | Name                                                                                              |
| :----- | :------ | :------------------------------------------------------------------------------------------------ |
| Linux  | amd64   | [koko-v4.10.17-linux-amd64.tar.gz][koko-v4.10.17-linux-amd64]     |
| Linux  | arm64   | [koko-v4.10.17-linux-arm64.tar.gz][koko-v4.10.17-linux-arm64]     |
| linux  | loong64 | [koko-v4.10.17-linux-loong64.tar.gz][koko-v4.10.17-linux-loong64] |
| Darwin | amd64   | [koko-v4.10.17-darwin-amd64.tar.gz][koko-v4.10.17-darwin-amd64]   |
| Darwin | arm64   | [koko-v4.10.17-darwin-arm64.tar.gz][koko-v4.10.17-darwin-arm64]   |
        ### Linux/amd64
...
rm -rf linux-amd64
wget https://github.com/jumpserver/koko/releases/download/v4.10.17/koko-v4.10.17-linux-amd64.tar.gz
tar -xf koko-v4.10.17-linux-amd64.tar.gz -C /opt
cd koko-v4.10.17-linux-amd64
...
chown root:root /usr/local/bin/rawkubectl /usr/local/bin/rawhelm
rm -rf linux-arm64
wget https://github.com/jumpserver/koko/releases/download/v4.10.17/koko-v4.10.17-linux-arm64.tar.gz
tar -xf koko-v4.10.17-linux-arm64.tar.gz -C /opt
cd koko-v4.10.17-linux-arm64
mv kubectl /usr/local/bin/kubectl
```
### 1.3 修改配置文件
:::note
