...
![v4_web_terminal_1](/img/jumpserver/v4_web_terminal_1.png)
...
![av4_web_terminal_2](/img/jumpserver/v4_web_terminal_2.png)

## 2 批量资产连接

- Web 终端页面支持用户批量连接资产。通过页面左上角的批量选项选择需要连接的资产，对资产批量发起连接操作。
![v4_web_terminal_3](/img/jumpserver/v4_web_terminal_3.png)

## 3 会话拖拽

- 用户使用 **Web Terminal** 方式连接资产时，支持对相应的 Tab 窗口手动拖拽，调整排列位置。
![v4_web_terminal_4](/img/jumpserver/v4_web_terminal_4.png)
...
![v4_web_terminal_5](/img/jumpserver/v4_web_terminal_5.png)
...
![v4_web_terminal_6](/img/jumpserver/v4_web_terminal_6.png)


- Web SFTP连接结果如下图所示：
![v4_web_terminal_8](/img/jumpserver/v4_web_terminal_8.png)
...
![v4_web_terminal_17](/img/jumpserver/v4_web_terminal_17.png)
...
![v4_web_terminal_19](/img/jumpserver/v4_web_terminal_19.png)
![v4_web_terminal_20](/img/jumpserver/v4_web_terminal_20.png)
...
![v4_web_terminal_21](/img/jumpserver/v4_web_terminal_21.png)
...
- 在 Web 终端页面点击数据库，选择 **远程应用**  方式连接数据库。使用此方式的前提，需要管理员提前设置了远程应用并发布了远程应用 Navicat 或者 DBeaver。远程应用模块具体解释可参考 [远程应用](../../system_settings/remote_apps) 部分。

## 7 文件管理

- 在 Web 终端页面，点击 **文件管理** 按钮，选择 **连接** 按钮即可进入文件管理模块。文件管理模块具体解释可参考 [文件管理](file_explorer) 部分。

## 8 视图

-  **视图**  按钮用于全屏显示资产连接界面（仅在连接资产时可用）。
![v4_web_terminal_22](/img/jumpserver/v4_web_terminal_22.png)

## 9 语言

- JumpServer 支持多种语言，包括英语、中文、日语、葡萄牙语、西班牙语、俄语。通过  **语言**  按钮可以切换 JumpServer 系统的显示语言。
![v4_web_terminal_23](/img/jumpserver/v4_web_terminal_23.png)
...
![v4_web_terminal_24](/img/jumpserver/v4_web_terminal_24.png)
...
![v4_web_terminal_26](/img/jumpserver/v4_web_terminal_26.png)

## 12 窗口列表

-  **窗口列表**  按钮可查看正在连接的所有会话并进行切换。
![v4_web_terminal_25](/img/jumpserver/v4_web_terminal_25.png)