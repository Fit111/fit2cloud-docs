...
## 3 资产类型
:::note[注: Oracle、SQL Server、ClickHouse、Dameng、DB2、ClickHouse 数据库均为 JumpServer 企业版功能。]
...
- Web 类型中默认包含网站类资产。Web 类型资产详细配置见 [创建Web资产](web_assets)。
:::
...
:::note[云同步任务自动释放行为说明（v4.10.4及以后版本特性）]
...
![V4_assets_detail_14](/img/jumpserver/V4_assets_detail_14.png)
...
![V4_assets_delete_15](/img/jumpserver/V4_assets_delete_15.png)
...
:::
![V4_assets_clone_1](/img/jumpserver/V4_assets_clone_1.png)
...
:::
![V4_assets_adduser_14](/img/jumpserver/V4_assets_adduser_14.png)
![V4_assets_adduser_10](/img/jumpserver/V4_assets_adduser_10.png)
