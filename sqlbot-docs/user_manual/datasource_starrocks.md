...
<img src="/img/sqlbot/user_manual/datasource/add_starrocks.png" alt="配置StarRocks" style={{maxWidth:'720px',width:'100%',display:'block',margin:'16px auto 6px',borderRadius:'4px'}} />
<div style={{fontSize:'14px',color:'#666',margin:'0 0 16px',textAlign:'center'}}>图 2 配置 StarRocks 连接信息</div>
...
<img src="/img/sqlbot/user_manual/datasource/save_starrocks.png" alt="配置StarRocks" style={{maxWidth:'720px',width:'100%',display:'block',margin:'16px auto 6px',borderRadius:'4px'}} />
...
<img src="/img/sqlbot/user_manual/datasource/question_starrocks.png" alt="配置StarRocks" style={{maxWidth:'720px',width:'100%',display:'block',margin:'16px auto 6px',borderRadius:'4px'}} />
