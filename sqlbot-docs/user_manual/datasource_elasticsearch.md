...
<img src="/img/sqlbot/user_manual/datasource/add_elasticsearch.png" alt="配置elasticsearch" style={{maxWidth:'720px',width:'100%',display:'block',margin:'16px auto 6px',borderRadius:'4px'}} />
<div style={{fontSize:'14px',color:'#666',margin:'0 0 16px',textAlign:'center'}}>图 2 配置 Elasticsearch 连接信息</div>
...
<img src="/img/sqlbot/user_manual/datasource/save_elasticsearch.png" alt="配置elasticsearch" style={{maxWidth:'720px',width:'100%',display:'block',margin:'16px auto 6px',borderRadius:'4px'}} />
...
<img src="/img/sqlbot/user_manual/datasource/question_elasticsearch.png" alt="配置elasticsearch" style={{maxWidth:'720px',width:'100%',display:'block',margin:'16px auto 6px',borderRadius:'4px'}} />
