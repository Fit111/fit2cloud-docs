...
<img src="/img/sqlbot/user_manual/datasource/add_clickhouse.png" alt="配置 ClickHouse 连接信息" style={{maxWidth:'720px',width:'100%',display:'block',margin:'16px auto 6px',borderRadius:'4px'}} />
<div style={{fontSize:'14px',color:'#666',margin:'0 0 16px',textAlign:'center'}}>图 2 配置 ClickHouse 连接信息</div>
...
<img src="/img/sqlbot/user_manual/datasource/question_clickhouse.png" alt="问数 ClickHouse" style={{maxWidth:'720px',width:'100%',display:'block',margin:'16px auto 6px',borderRadius:'4px'}} />
