                  ...
                  "items": [
                    {
                      ...
                      "label": "用户列表",
                      "key": "doc:用户手册/管理员手册/控制台/用户管理/用户列表"
                    },
                    {
                      "type": "doc",
                      "id": "manual/admin/console/users/user-groups",
                      "label": "用户组",
                      "key": "doc:用户手册/管理员手册/控制台/用户管理/用户组"
                    }
                  ],
                  "key": "cat:用户手册/管理员手册/控制台/用户管理"
                },
                {
                  "type": "category",
                  "label": "资产管理",
                  ...
                  "items": [
                    {
                      ...
                      "label": "资产列表",
                      "key": "doc:用户手册/管理员手册/控制台/资产管理/资产列表"
                    },
                    {
                      "type": "doc",
                      "id": "manual/admin/console/assets/net_list",
                      "label": "网域列表",
                      "key": "doc:用户手册/管理员手册/控制台/资产管理/网域列表"
                    },
                    {
                      "type": "doc",
                      "id": "manual/admin/console/assets/web_assets",
                      "label": "Web资产",
                      "key": "doc:用户手册/管理员手册/控制台/资产管理/Web资产"
                    }
                  ],
                  "key": "cat:用户手册/管理员手册/控制台/资产管理"
                },
                {
                  "type": "category",
                  "label": "账号管理",
                  ...
                  "items": [
                    {
                      ...
                      "label": "账号列表",
                      "key": "doc:用户手册/管理员手册/控制台/账号管理/账号列表"
                    },
                    {
                      "type": "doc",
                      "id": "manual/admin/console/account_management/account_template",
                      "label": "账号模板",
                      "key": "doc:用户手册/管理员手册/控制台/账号管理/账号模板"
                    }
                  ],
                  "key": "cat:用户手册/管理员手册/控制台/账号管理"
                },
                {
                  "type": "category",
                  "label": "授权管理",
                  ...
                  "items": [
                    {
                      ...
                      "label": "资产授权",
                      "key": "doc:用户手册/管理员手册/控制台/授权管理/资产授权"
                    },
                    {
                      "type": "doc",
                      "id": "manual/admin/console/access_control/acls",
                      "label": "访问控制",
                      "key": "doc:用户手册/管理员手册/控制台/授权管理/访问控制"
                    },
                    {
                      "type": "doc",
                      "id": "manual/admin/console/authorization_manage/session_sharing",
                      "label": "会话分享",
                      "key": "doc:用户手册/管理员手册/控制台/授权管理/会话分享"
                    }
                  ],
                  "key": "cat:用户手册/管理员手册/控制台/授权管理"
                },
                {
                  "type": "doc",
                  "id": "manual/admin/console/else/tag_list",
                  "label": "标签列表",
                  "key": "doc:用户手册/管理员手册/控制台/标签列表"
                }
              ],
              "key": "cat:用户手册/管理员手册/控制台"
            },
            {
              "type": "category",
              "label": "PAM",
                  ...
                  "items": [
                    {
                      ...
                      "label": "账号发现",
                      "key": "doc:用户手册/管理员手册/PAM/自动化/账号发现"
                    },
                    {
                      "type": "doc",
                      "id": "manual/admin/pam/automation/account_push",
                      "label": "账号推送",
                      "key": "doc:用户手册/管理员手册/PAM/自动化/账号推送"
                    },
                    {
                      "type": "doc",
                      "id": "manual/admin/pam/automation/account_backup",
                      "label": "账号备份",
                      "key": "doc:用户手册/管理员手册/PAM/自动化/账号备份"
                    }
                  ],
                  "key": "cat:用户手册/管理员手册/PAM/自动化"
                },
                {
                  "type": "category",
                  "label": "安全设置",
                  ...
                  "items": [
                    {
                      ...
                      "label": "账号改密",
                      "key": "doc:用户手册/管理员手册/PAM/安全设置/账号改密"
                    },
                    {
                      "type": "doc",
                      "id": "manual/admin/pam/security/risk_detection",
                      "label": "风险检测",
                      "key": "doc:用户手册/管理员手册/PAM/安全设置/风险检测"
                    }
                  ],
                  "key": "cat:用户手册/管理员手册/PAM/安全设置"
                },
                {
                  "type": "doc",
                  "id": "manual/admin/pam/applications_manage",
                  "label": "应用管理",
                  "key": "doc:用户手册/管理员手册/PAM/应用管理"
                }
              ],
              "key": "cat:用户手册/管理员手册/PAM"
            },
            {
              "type": "category",
              "label": "审计台",
                  ...
                  "items": [
                    {
                      ...
                      "label": "会话记录",
                      "key": "doc:用户手册/管理员手册/审计台/会话审计/会话记录"
                    },
                    {
                      "type": "doc",
                      "id": "manual/admin/audit/session_audit/session_command",
                      "label": "会话命令",
                      "key": "doc:用户手册/管理员手册/审计台/会话审计/会话命令"
                    },
                    {
                      "type": "doc",
                      "id": "manual/admin/audit/session_audit/file_transfer",
                      "label": "文件传输",
                      "key": "doc:用户手册/管理员手册/审计台/会话审计/文件传输"
                    },
                    {
                      "type": "doc",
                      "id": "manual/admin/audit/session_audit/online_user",
                      "label": "在线用户",
                      "key": "doc:用户手册/管理员手册/审计台/会话审计/在线用户"
                    }
                  ],
                  "key": "cat:用户手册/管理员手册/审计台/会话审计"
                },
                {
                  "type": "category",
                  "label": "日志审计",
                  ...
                  "items": [
                    {
                      ...
                      "label": "作业列表",
                      "key": "doc:用户手册/管理员手册/审计台/作业审计/作业列表"
                    },
                    {
                      "type": "doc",
                      "id": "manual/admin/audit/session_audit/job_audit/job_logs",
                      "label": "作业日志",
                      "key": "doc:用户手册/管理员手册/审计台/作业审计/作业日志"
                    }
                  ],
                  "key": "cat:用户手册/管理员手册/审计台/作业审计"
                },
                {
                  "type": "doc",
                  "id": "manual/admin/audit/session_audit/ticket_audit",
                  "label": "工单审计",
                  "key": "doc:用户手册/管理员手册/审计台/工单审计"
                },
                {
                  "type": "doc",
                  "id": "manual/admin/audit/session_audit/reports",
                  "label": "报表",
                  "key": "doc:用户手册/管理员手册/审计台/报表"
                }
              ],
              "key": "cat:用户手册/管理员手册/审计台"
            },
            {
              "type": "category",
              "label": "工作台",
                  ...
                  "items": [
                    {
                      ...
                      "label": "连接资产",
                      "key": "doc:用户手册/管理员手册/工作台/我的资产/连接资产"
                    },
                    {
                      "type": "doc",
                      "id": "manual/admin/workbench/my_assets/web_terminal",
                      "label": "Web终端",
                      "key": "doc:用户手册/管理员手册/工作台/我的资产/Web终端"
                    },
                    {
                      "type": "doc",
                      "id": "manual/admin/workbench/my_assets/file_transfer",
                      "label": "文件传输",
                      "key": "doc:用户手册/管理员手册/工作台/我的资产/文件传输"
                    },
                    {
                      "type": "doc",
                      "id": "manual/admin/workbench/my_assets/file_explorer",
                      "label": "文件管理",
                      "key": "doc:用户手册/管理员手册/工作台/我的资产/文件管理"
                    }
                  ],
                  "key": "cat:用户手册/管理员手册/工作台/我的资产"
                },
                {
                  "type": "category",
                  "label": "作业中心",
                  ...
                  "items": [
                    {
                      ...
                      "label": "系统工具",
                      "key": "doc:用户手册/管理员手册/工作台/其他/系统工具"
                    }
                  ],
                  "key": "cat:用户手册/管理员手册/工作台/其他"
                }
              ],
              "key": "cat:用户手册/管理员手册/工作台"
            },
            {
              "type": "category",
              "label": "系统设置",
              ...
              "items": [
                {
                  ...
                  "label": "人脸识别 (X-Pack)",
                  "key": "doc:用户手册/管理员手册/其他设置/人脸识别 (X-Pack)"
                }
              ],
              "key": "cat:用户手册/管理员手册/其他设置"
            }
          ],
          "key": "cat:用户手册/管理员手册"
        },
                  ...
                  "items": [
                    {
                      ...
                      "id": "manual/admin/audit/session_audit/session_record",
                      "label": "会话记录",
                      "key": "doc:用户手册/审计员手册/审计台/会话审计/会话记录"
                    },
                    {
                      "type": "doc",
                      "id": "manual/admin/audit/session_audit/session_command",
                      "label": "会话命令",
                      "key": "doc:用户手册/审计员手册/审计台/会话审计/会话命令"
                    },
                    {
                      "type": "doc",
                      "id": "manual/admin/audit/session_audit/file_transfer",
                      "label": "文件传输",
                      "key": "doc:用户手册/审计员手册/审计台/会话审计/文件传输"
                    },
                    {
                      "type": "doc",
                      "id": "manual/admin/audit/session_audit/online_user",
                      "label": "在线用户",
                      "key": "doc:用户手册/审计员手册/审计台/会话审计/在线用户"
                    }
                  ],
                  "key": "cat:用户手册/审计员手册/审计台/会话审计"
                },
                {
                  "type": "category",
                  "label": "日志审计",
                  ...
                  "items": [
                    {
                      ...
                      "id": "manual/admin/audit/session_audit/log_audit/login_logs",
                      "label": "登录日志",
                      "key": "doc:用户手册/审计员手册/审计台/日志审计/登录日志"
                    },
                    {
                      "type": "doc",
                      "id": "manual/admin/audit/session_audit/log_audit/password_change_logs",
                      "label": "改密日志",
                      "key": "doc:用户手册/审计员手册/审计台/日志审计/改密日志"
                    },
                    {
                      "type": "doc",
                      "id": "manual/admin/audit/session_audit/log_audit/operation_logs",
                      "label": "操作日志",
                      "key": "doc:用户手册/审计员手册/审计台/日志审计/操作日志"
                    }
                  ],
                  "key": "cat:用户手册/审计员手册/审计台/日志审计"
                },
                {
                  "type": "category",
                  "label": "作业审计",
                  ...
                  "items": [
                    {
                      ...
                      "id": "manual/admin/audit/session_audit/job_audit/job_list",
                      "label": "作业列表",
                      "key": "doc:用户手册/审计员手册/审计台/作业审计/作业列表"
                    },
                    {
                      "type": "doc",
                      "id": "manual/admin/audit/session_audit/job_audit/job_logs",
                      "label": "作业日志",
                      "key": "doc:用户手册/审计员手册/审计台/作业审计/作业日志"
                    }
                  ],
                  "key": "cat:用户手册/审计员手册/审计台/作业审计"
                },
                {
                  "type": "doc",
                  "id": "manual/admin/audit/session_audit/ticket_audit",
                  "label": "工单审计",
                  "key": "doc:用户手册/审计员手册/审计台/工单审计"
                }
              ],
              "key": "cat:用户手册/审计员手册/审计台"
            },
            {
              "type": "doc",
              "id": "manual/admin/audit/session_audit/reports",
              "label": "报表",
              "key": "doc:用户手册/审计员手册/报表"
            }
          ],
          "key": "cat:用户手册/审计员手册"
        },
                  ...
                  "items": [
                    {
                      ...
                      "id": "manual/admin/workbench/my_assets/assets_connect",
                      "label": "连接资产",
                      "key": "doc:用户手册/普通用户手册/工作台/我的资产/连接资产"
                    },
                    {
                      "type": "doc",
                      "id": "manual/admin/workbench/my_assets/web_terminal",
                      "label": "Web终端",
                      "key": "doc:用户手册/普通用户手册/工作台/我的资产/Web终端"
                    },
                    {
                      "type": "doc",
                      "id": "manual/admin/workbench/my_assets/file_transfer",
                      "label": "文件传输",
                      "key": "doc:用户手册/普通用户手册/工作台/我的资产/文件传输"
                    },
                    {
                      "type": "doc",
                      "id": "manual/admin/workbench/my_assets/file_explorer",
                      "label": "文件管理",
                      "key": "doc:用户手册/普通用户手册/工作台/我的资产/文件管理"
                    }
                  ],
                  "key": "cat:用户手册/普通用户手册/工作台/我的资产"
                }
              ],
              "key": "cat:用户手册/普通用户手册/工作台"
            },
            {
              "type": "doc",
              "id": "manual/user/ticket",
              "label": "工单",
              "key": "doc:用户手册/普通用户手册/工单"
            },
            {
              "type": "category",
              "label": "客户端使用",
              ...
              "items": [
                {
                  ...
                  "label": "客户端下载与安装",
                  "key": "doc:用户手册/普通用户手册/客户端使用/客户端下载与安装"
                },
                {
                  "type": "doc",
                  "id": "manual/client/asset_connection",
                  "label": "资产连接",
                  "key": "doc:用户手册/普通用户手册/客户端使用/资产连接"
                },
                {
                  "type": "doc",
                  "id": "manual/client/connection_settings",
                  "label": "连接设置",
                  "key": "doc:用户手册/普通用户手册/客户端使用/连接设置"
                },
                {
                  "type": "doc",
                  "id": "manual/client/tool",
                  "label": "工具",
                  "key": "doc:用户手册/普通用户手册/客户端使用/工具"
                }
              ],
              "key": "cat:用户手册/普通用户手册/客户端使用"
            }
          ],
          "key": "cat:用户手册/普通用户手册"
        }
