...
离线包解压需要 tar 命令, 参考 [环境要求](./requirements) 手动安装
| OS/Arch       | Architecture | Linux Kernel | Offline Name                                                                                 |
| :------------ | :----------- | :----------- | :------------------------------------------------------------------------------------------- |
| linux/amd64   | x86_64       | &gt;= 4.0       | jumpserver-offline-installer-v3.10.21-amd64.tar.gz   |
...
# 完整参数文档 /jumpserver/v3/zh/master/admin-guide/env
...
# 如果外置 MySQL 需要开启 TLS/SSL 连接, 参考 /jumpserver/v3/zh/master/install/install_security
#
# DB_USE_SSL=True
...
# 如果外置 Redis 需要开启 TLS/SSL 连接, 参考 /jumpserver/v3/zh/master/install/install_security
#
# REDIS_USE_SSL=True
...
################################# HTTPS 配置 #################################
# 参考 /jumpserver/v3/zh/master/admin-guide/proxy 配置
#
# HTTPS_PORT=443
...
```sh
cd jumpserver-offline-release-v3.10.21-amd64
