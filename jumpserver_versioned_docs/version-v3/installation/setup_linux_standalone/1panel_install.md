...
![1panel页面](/img/jumpserver-v3/1panel_install_01.png)
...
![安装 MySQL 数据库_01](/img/jumpserver-v3/1panel_install_02.png)

![安装 MySQL 数据库_02](/img/jumpserver-v3/1panel_install_03.png)
...
![安装 Redis 数据库](/img/jumpserver-v3/1panel_install_04.png)
...
![数据库状态检查](/img/jumpserver-v3/1panel_install_05.png)
...
![安装 JumpServer](/img/jumpserver-v3/1panel_install_06.png)
...
![安装 JumpServer](/img/jumpserver-v3/1panel_install_07.png)
...
![检查 JumpServer](/img/jumpserver-v3/1panel_install_08.png)
...
![访问 JumpServer](/img/jumpserver-v3/1panel_install_09.png)
