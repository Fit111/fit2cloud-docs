...
```bash
cd /opt
mkdir /opt/lina-v3.10.21
wget -O /opt/lina-v3.10.21.tar.gz https://github.com/jumpserver/lina/archive/refs/tags/v3.10.21.tar.gz
tar -xf lina-v3.10.21.tar.gz -C /opt/lina-v3.10.21 --strip-components 1
```
...
```
        ...
        ```bash
        sed -i "s@Version <strong>.*</strong>@Version <strong>v3.10.21</strong>@g" src/layout/components/Footer/index.vue
        vi .env.development
        ```
        ```yaml
        # 全局环境变量 请勿随意改动
        ...
        ```bash
        yarn build
        cp -rf lina lina-v3.10.21
        tar -czf lina-v3.10.21.tar.gz lina-v3.10.21
        ```
...
| OS     | Arch  | Name                                                          |
| :----- | :---- | :------------------------------------------------------------ |
| All    | All   | [lina-v3.10.21.tar.gz][lina-v3.10.21] |

```bash
cd /opt
wget https://github.com/jumpserver/lina/releases/download/v3.10.21/lina-v3.10.21.tar.gz
tar -xf lina-v3.10.21.tar.gz
```
