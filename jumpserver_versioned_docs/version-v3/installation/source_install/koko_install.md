...
```bash
cd /opt
mkdir /opt/koko-v3.10.21
wget -O /opt/koko-v3.10.21.tar.gz https://github.com/jumpserver/koko/archive/refs/tags/v3.10.21.tar.gz
tar -xf koko-v3.10.21.tar.gz -C /opt/koko-v3.10.21 --strip-components 1
```
...
| OS     | Arch    | Name                                                                                              |
| :----- | :------ | :------------------------------------------------------------------------------------------------ |
| Linux  | amd64   | [koko-v3.10.21-linux-amd64.tar.gz][koko-v3.10.21-linux-amd64]     |
| Linux  | arm64   | [koko-v3.10.21-linux-arm64.tar.gz][koko-v3.10.21-linux-arm64]     |
| linux  | loong64 | [koko-v3.10.21-linux-loong64.tar.gz][koko-v3.10.21-linux-loong64] |
| Darwin | amd64   | [koko-v3.10.21-darwin-amd64.tar.gz][koko-v3.10.21-darwin-amd64]   |
| Darwin | arm64   | [koko-v3.10.21-darwin-arm64.tar.gz][koko-v3.10.21-darwin-arm64]   |
        ### Linux/amd64
...
rm -rf linux-amd64
wget https://github.com/jumpserver/koko/releases/download/v3.10.21/koko-v3.10.21-linux-amd64.tar.gz
tar -xf koko-v3.10.21-linux-amd64.tar.gz -C /opt
cd koko-v3.10.21-linux-amd64
...
chown root:root /usr/local/bin/rawkubectl /usr/local/bin/rawhelm
rm -rf linux-arm64
wget https://github.com/jumpserver/koko/releases/download/v3.10.21/koko-v3.10.21-linux-arm64.tar.gz
tar -xf koko-v3.10.21-linux-arm64.tar.gz -C /opt
cd koko-v3.10.21-linux-arm64
mv kubectl /usr/local/bin/kubectl
```
### 1.3 修改配置文件
:::note
