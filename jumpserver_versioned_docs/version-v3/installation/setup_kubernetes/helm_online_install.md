...
core:
  ...
  env:
    ## See: /jumpserver/v3/zh/master/admin-guide/env
    SESSION_EXPIRE_AT_BROWSER_CLOSE: true
    # SESSION_COOKIE_AGE: 86400
    # SECURITY_VIEW_AUTH_NEED_MFA: true
    ## Django CSRF_TRUSTED_ORIGINS need to be set to the domain name of the jumpserver (/jumpserver/v3/installation/upgrade_notice)
