...
>>> 加载 Docker 镜像
Docker: Pulling from jumpserver/core:v3.10.21 	    [ OK ]
Docker: Pulling from jumpserver/koko:v3.10.21 	    [ OK ]
Docker: Pulling from jumpserver/web:v3.10.21 	    [ OK ]
Docker: Pulling from jumpserver/redis:6-alpine      [ OK ]
Docker: Pulling from jumpserver/mysql:5 	        [ OK ]
Docker: Pulling from jumpserver/lion:v3.10.21 	    [ OK ]
...
>>> 安装完成了
1. 可以使用如下命令启动, 然后访问
cd /root/jumpserver-installer-v3.10.21
./jmsctl.sh start
