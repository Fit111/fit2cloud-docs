...
![currency01](/img/jumpserver-v3/currency01.png)
...
![currency02](/img/jumpserver-v3/currency02.png)

## 3 "更多"按钮
### 3.1 针对资产、用户类型

- JumpServer 在功能模块中设有`"更多"`按钮来方便管理员对资产、用户等类型的目标进行删除、克隆、测试动作，如下图所示：
![currency03](/img/jumpserver-v3/currency03.png)

### 3.2 针对任务、规则类型

- JumpServer 在功能模块中设有`"更多"`按钮来方便管理员对任务、规则等类型等目标进行删除、执行（手动执行任务）动作，如下图所示：
![currency04](/img/jumpserver-v3/currency04.png)

## 4 数据导入导出

- JumpServer 支持通过 excel、csv 模版来对数据进行导入导出操作。
- 数据类型：资产、账号、授权规则。
![currency05](/img/jumpserver-v3/currency05.png)

## 5 自定义列表字段

- JumpServer 支持在功能模块中的页面进行自定义列表字段操作。
![currency06](/img/jumpserver-v3/currency06.png)
