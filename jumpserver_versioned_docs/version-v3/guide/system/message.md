...
![notify01](/img/jumpserver-v3/notify01.png)
...
![notify02](/img/jumpserver-v3/notify02.png)
...
![notify03](/img/jumpserver-v3/notify03.png)

### 2.2 配置说明

- 选择对应的短信服务商，填入服务商平台认证相关信息，点击`测试`按钮可测试配置是否正确。
![sms02](/img/jumpserver-v3/sms02.png)

### 2.3 用户侧配置

- 点击用户头像 - `个人信息` - 左侧栏`认证设置`配置用户个人手机号信息。
![sms04](/img/jumpserver-v3/sms04.png)


- 点击用户头像 - `个人信息` - 左侧栏`用户信息`配置多因子认证为短信认证。
![sms03](/img/jumpserver-v3/sms03.png)
...
![notify04](/img/jumpserver-v3/notify04.png)

### 3.1 设置消息接收人

- 点击`修改消息接收人`按钮，进入消息接收人设置界面。
- 根据步骤① 选择需要接受消息的人，步骤② 加入消息接收人行列，点击步骤③ 确认。
![message02](/img/jumpserver-v3/message02.png)
