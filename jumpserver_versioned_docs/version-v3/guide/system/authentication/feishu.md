...
- 点击 `创建企业自建应用`。
:::
![飞书创建应用](/img/jumpserver-v3/feishu_01.png)

:::note

- 输入 `应用名称` 和 `应用描述` 后点击创建。
:::
![飞书创建应用02](/img/jumpserver-v3/feishu_02.png)
...
- 点击刚创建的应用，进入应用详情页。
:::
![应用详情](/img/jumpserver-v3/feishu_03.png)
...
:::
![启用机器人](/img/jumpserver-v3/feishu_04.png)
...
:::
![安全设置](/img/jumpserver-v3/feishu_05.png)
...
:::
![权限管理](/img/jumpserver-v3/feishu_06.png)
...
:::
![创建版本](/img/jumpserver-v3/feishu_07.png)

:::note

- 应用功能选择 `机器人`，输入 `应用版本号` 等必要信息后点击保存。
:::
![创建版本](/img/jumpserver-v3/feishu_08.png)

:::note

- 在页面右上角选中 `申请线上发布`。
:::
![申请发布](/img/jumpserver-v3/feishu_09.png)

:::note

- 打开 `飞书管理后台` 页面，在左侧菜单 `工作台` 中，点击 `应用审核` ，找到刚才提交的应用，点击 `审核` 通过。
:::
![应用审核](/img/jumpserver-v3/feishu_10.png)

:::note

- 确定 `应用列表` 的应用已经处于 `已启用` 状态。
:::
![检查应用](/img/jumpserver-v3/feishu_11.png)
...
:::
![查看凭据](/img/jumpserver-v3/feishu_12.png)
...
:::
![查看凭据](/img/jumpserver-v3/feishu_13.png)
...
:::
![查看凭据](/img/jumpserver-v3/feishu_15.png)
...
:::
![查看凭据](/img/jumpserver-v3/feishu_14.png)