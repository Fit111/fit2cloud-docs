...
![platform_list01](/img/jumpserver-v3/platform_list01.png)

## 2 资产平台的创建

- 点击平台列表页面的`创建`按钮，填写资产平台的信息即可创建新的资产平台，以 Linux 为例。
![platform_list02](/img/jumpserver-v3/platform_list02.png)
![platform_list03](/img/jumpserver-v3/platform_list03.png)
...
![platform_list04](/img/jumpserver-v3/platform_list04.png)


- 自定义修改 SFTP home 目录即可。
![platform_list05](/img/jumpserver-v3/platform_list05.png)
