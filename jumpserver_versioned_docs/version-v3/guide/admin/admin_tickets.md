...
![admin_tickets05](/img/jumpserver-v3/admin_tickets05.png)

## 4 流程设置
### 4.1 查看

- 点击`申请资产`按钮即可进入申请资产的流程详情页，查看申请资产工单的基本信息以及审批信息。
![admin_tickets06](/img/jumpserver-v3/admin_tickets06.png)
...
![admin_tickets07](/img/jumpserver-v3/admin_tickets07.png)