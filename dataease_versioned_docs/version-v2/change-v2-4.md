...
:::
![更新1](/img/dataease-v2/newimg/更新v2-4-0-1.PNG)
![更新1](/img/dataease-v2/newimg/更新v2-4-0-2.PNG)

## 2 移动端 仪表板与数据大屏

### 2.1 数据大屏新增图形素材

![更新1](/img/dataease-v2/newimg/更新v2-4-0-3.PNG)
...
使用组件自带的按键或键盘快捷键均可。
:::
![更新1](/img/dataease-v2/newimg/更新v2-4-0-5.PNG)
### 2.3 明细表/汇总表支持按列设置宽度
:::note

方式一：手动针对各个字段配置所占表格宽度的百分比。
:::
![更新1](/img/dataease-v2/newimg/更新v2-4-0-6.png)
:::note

方式二：手动拖拉。
:::
![更新1](/img/dataease-v2/newimg/更新v2-4-0-7.png)
:::note

请注意，在预览界面与编辑界面均支持手动拖拉表格宽度，但只有编辑界面下拖拉完成保存后生效，在预览界面拖拉仅用于临时使用，刷新页面后将还原。
:::
![更新1](/img/dataease-v2/newimg/更新v2-4-0-8.png)
### 2.4 表格支持斑马纹
![更新1](/img/dataease-v2/newimg/更新v2-4-0-9.png)
### 2.5 表格支持右键复制单元格内容
:::note

鼠标悬浮到某一单元格上，点击右键，即可复制当前单元格内容。（注意，这里不会另外弹出复制按钮，右键之后就已经完成了复制）
:::
![更新1](/img/dataease-v2/newimg/更新v2-4-0-10.gif)
...
![更新1](/img/dataease-v2/newimg/更新v2-4-0-11-移动端设置.png)
![更新1](/img/dataease-v2/newimg/更新v2-4-0-12-移动端样式.png)
...
:::
![更新1](/img/dataease-v2/newimg/Group%201%20(4).png)
...
:::
![更新1](/img/dataease-v2/newimg/更新v2-4-0-15外观设置.png)
![更新1](/img/dataease-v2/newimg/更新v2-4-0-16外观设置2.png)
![更新1](/img/dataease-v2/newimg/更新v2-4-0-17外观设置3.png)
### 4.3 支持引擎设置
:::note

可将 Excel 数据及 API 数据同步至该引擎数据库中，仅支持 MySQL。
:::
![更新1](/img/dataease-v2/newimg/更新v2-4-0-引擎设置.png)
...
## 6 工作台
### 6.1 支持在我的收藏页取消收藏操作
![更新1](/img/dataease-v2/newimg/更新v2-4-0-20工作台.png)
