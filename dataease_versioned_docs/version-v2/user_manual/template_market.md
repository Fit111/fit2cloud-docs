...
![模板市场入口](/img/dataease-v2/template_market/模板市场入口.png)
:::note
...
![点击应用模板](/img/dataease-v2/template_market/点击应用模板.png)

![点击应用模板](/img/dataease-v2/template_market/点击应用模板2.png)

![应用模板](/img/dataease-v2/template_market/应用模板.png)
...
![线上模板市场](/img/dataease-v2/template_market/线上模板市场.png)
...
![版本切换](/img/dataease-v2/template_market/版本切换.gif)
...
![模板类型切换](/img/dataease-v2/template_market/模板类型选择.gif)
...
![模板类型切换](/img/dataease-v2/template_market/模板类型切换.gif)
...
![主题切换](/img/dataease-v2/template_market/主题切换.gif)
...
![模板市场_下载](/img/dataease-v2/template_market/模板下载.png)
...
![模板导入成功](/img/dataease-v2/template_market/应用模板.png)
...
![模板市场_替换数据集](/img/dataease-v2/template_market/模板替换数据集.png)
...
![模板市场_替换数据](/img/dataease-v2/template_market/替换数据集.png)
...
![仪表板市场_样式调整](/img/dataease-v2/template_market/样式调整.png)