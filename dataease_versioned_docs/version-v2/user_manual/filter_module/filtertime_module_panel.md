...
![年份组件入口](/img/dataease-v2/dashboard_generation/数据大屏过滤组件年.png)  
![仪表盘编辑_过滤组件](/img/dataease-v2/dashboard_generation/数据大屏过滤组件筛选年.png)  
...
![年份组件入口](/img/dataease-v2/dashboard_generation/数据大屏过滤组件年月.png)  
![仪表盘编辑_过滤组件](/img/dataease-v2/dashboard_generation/数据大屏过滤组件筛选年月.png)
...
![年份组件入口](/img/dataease-v2/dashboard_generation/数据大屏过滤组件年月日.png)  
![仪表盘编辑_过滤组件](/img/dataease-v2/dashboard_generation/数据大屏年月日筛选.png)

:::note

日期过滤组件支持时分秒级别的设置。
:::
![年份组件入口](/img/dataease-v2/dashboard_generation/数据大屏过滤设置时分秒.png)  
...
:::
![仪表盘编辑_过滤组件](/img/dataease-v2/dashboard_generation/数据大屏时间范围区间设置.png)
