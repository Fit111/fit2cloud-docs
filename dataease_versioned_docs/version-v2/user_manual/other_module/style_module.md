...
![仪表板_富文本组件入口](/img/dataease-v2/dashboard_generation/2.0富文本组件点击.png)

![富文本组件_功能](/img/dataease-v2/dashboard_generation/2.0富文本组件.png)

双击输入文字，可单独调整某文字样式。

![富文本组件_调整样式](/img/dataease-v2/dashboard_generation/2.0富文本样式调整.png)

点击插入超链接按钮，可配置超链接，下示例图以插入”百度网页“链接为例。

![富文本组件_超链接](/img/dataease-v2/dashboard_generation/2.0超链接设置.png)

添加表格，输入文字，并可对表格单元格、行、列等做调整，如下图所示。

![富文本组件_表格](/img/dataease-v2/dashboard_generation/2.0富文本表格.png)

![富文本组件_表格](/img/dataease-v2/dashboard_generation/2.0富文本表格属性设置.png)

还支持插入图片、媒体。

![富文本组件_图片](/img/dataease-v2/dashboard_generation/2.0富文本插入图片或者媒体.png)

![富文本组件_媒体](/img/dataease-v2/dashboard_generation/2.0富文本插入媒体.png)
...
![仪表盘编辑_其他组件](/img/dataease-v2/dashboard_generation/仪表板图片组件.png)

![仪表盘编辑_其他组件](/img/dataease-v2/dashboard_generation/2.0点击上传图片.png)
...
![仪表盘编辑_其他组件](/img/dataease-v2/dashboard_generation/仪表板视频组件.png)
...
![仪表盘编辑_其他组件](/img/dataease-v2/dashboard_generation/仪表板流媒体组件.png)
...
![仪表盘编辑_其他组件](/img/dataease-v2/dashboard_generation/2.0Tab组件.png)

![Tab页展示视图](/img/dataease-v2/dashboard_generation/2.0选择tab1.png)
...
![更新1](/img/dataease-v2/newimg/1.1%20Tab%20组件支持轮播1.PNG)

Tab 组件的轮播在编辑状态下不生效，在预览模式下才会生效。

![更新1](/img/dataease-v2/newimg/1.1%20Tab%20组件支持轮播2.gif)
