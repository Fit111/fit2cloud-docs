...
![可选维度列表](/img/dataease-v2/view_generation/2.0数据大屏维度可选框.png)
...
![可选指标列表](/img/dataease-v2/view_generation/2.0数据大屏指标可选框.png)
...
![选择维度](/img/dataease-v2/view_generation/2.0数据大屏维度选择.png)
...
![维度属性设置](/img/dataease-v2/view_generation/2.0数据大屏维度排序.png)
...
![维度_更改字段名称入口](/img/dataease-v2/view_generation/2.0数据大屏显示别名.png)
...
![更新1](/img/dataease-v2/newimg/数据大屏排序支持设置优先级1.png)

![更新1](/img/dataease-v2/newimg/数据大屏排序支持设置优先级2.png)
...
![维度_自定义排序](/img/dataease-v2/view_generation/2.0数据大屏选择自定义排序.png)

![维度_自定义排序调整](/img/dataease-v2/view_generation/2.0数据大屏维度自定义排序.png)
...
![选择指标](/img/dataease-v2/view_generation/2.0数据大屏指标选择.png)
...
![指标设置](/img/dataease-v2/view_generation/2.0数据大屏指标汇总方式.png)
...
![同比环比](/img/dataease-v2/view_generation/2.0数据大屏指标快速计算.png)
...
![更新1](/img/dataease-v2/newimg/数据大屏指标卡同环比.png)  
![更新1](/img/dataease-v2/newimg/同环比增加具体数值选项.PNG)
...
![同比环比](/img/dataease-v2/view_generation/累计不支持类型.png)
...
![设置数值格式_指标卡展示结果](/img/dataease-v2/view_generation/2.0数值格式设置.png)
...
![更换数据集入口](/img/dataease-v2/view_generation/2.0数据大屏更换数据集入口.png)
...
![更换数据集](/img/dataease-v2/view_generation/2.0数据大屏更换数据集.png)
...
![添加视图](/img/dataease-v2/view_generation/2.0数据大屏明细数据.png)
...
![钻取](/img/dataease-v2/view_generation/2.0数据大屏数据下钻点击云南.png)
...
![钻取](/img/dataease-v2/view_generation/2.0数据下钻效果.png)
...
![图表样式](/img/dataease-v2/view_generation/数据大屏过滤器.png)
...
![图表样式](/img/dataease-v2/view_generation/数据大屏添加条件.png)
...
![更新1](/img/dataease-v2/newimg/数据大屏过滤器动态时间.png)
...
![视图刷新频率](/img/dataease-v2/view_generation/2.0数据大屏刷新与结果.png)
