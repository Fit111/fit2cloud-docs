...
![高级设置](/img/dataease-v2/view_generation/2.0高级设置.png)
...
![高级设置_缩略轴](/img/dataease-v2/view_generation/2.0缩略图设置.png)
...
![空值处理](/img/dataease-v2/view_generation/2.0柱状图空值处理.png)

![空值处理](/img/dataease-v2/view_generation/2.0折线图空值处理.png)
...
![高级设置_折线图空值处理](/img/dataease-v2/view_generation/2.0空值处理保存为空.png)

![高级设置_折线图空值处理](/img/dataease-v2/view_generation/2.0空值处理置为0.png)

![高级设置_折线图空值处理](/img/dataease-v2/view_generation/2.0空值处理隐藏空值.png)
...
![高级设置_折线图空值处理](/img/dataease-v2/view_generation/2.0表格空值处理2.png)

![高级设置_折线图空值处理](/img/dataease-v2/view_generation/2.0地图空值处理.png)
...
![更新1](/img/dataease-v2/view_generation/数据大屏辅助线新增【最后一项】选项1.png)

![更新1](/img/dataease-v2/.../../img/view_generation/数据大屏辅助线新增【最后一项】选项2.png)
...
![高级设置_阈值设置](/img/dataease-v2/view_generation/仪表板设置条件样式.png)  
![高级设置_阈值设置显示](/img/dataease-v2/view_generation/仪表板条件样式效果.png)
...
![高级设置_阈值设置仪表盘](/img/dataease-v2/view_generation/2.0仪表盘阈值.png)
...
![高级设置_表格滚动](/img/dataease-v2/view_generation/2.0滚动设置.png)  
![高级设置_表格滚动](/img/dataease-v2/view_generation/2.0滚动开启.png)
...
![气泡动效](/img/dataease-v2/newimg/1.10%20气泡地图添加水波纹动画配置.gif)

![气泡动效](/img/dataease-v2/newimg/1.11%20流向地图支持配置起止点名称及更多动效.gif)
