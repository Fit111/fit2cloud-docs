...
![系统设置](/img/dataease-v2/system_management/系统设置.png)
...
![系统管理界面](/img/dataease-v2/system_management/基础设置.png)
...
![数据源检测时间](/img/dataease-v2/system_management/数据源检测时间.png)
...
:::
![地图设置1](/img/dataease-v2/system_management/邮件设置.png)
...
![地图设置1](/img/dataease-v2/system_management/地图界面.png)

![地图设置2](/img/dataease-v2/system_management/添加地图文件.png)
...
![地图设置geo文件](/img/dataease-v2/system_management/地图设置geo文件.png)
...
![俄罗斯地图](/img/dataease-v2/system_management/俄罗斯地图.png)
...
![数据文件](/img/dataease-v2/system_management/数据文件.png)
...
![country](/img/dataease-v2/system_management/country.png)
...
![province](/img/dataease-v2/system_management/地图设置geo文件.png)
...
![俄罗斯](/img/dataease-v2/system_management/俄罗斯.png)

![世界地图](/img/dataease-v2/system_management/世界地图.png)
...
![高德【平台](/img/dataease-v2/system_management/高德平台.PNG)
...
![web服务](/img/dataease-v2/system_management/高德平台.PNG)
...
![开发指南](/img/dataease-v2/system_management/高德开发指南.PNG)
...
![地图指南](/img/dataease-v2/system_management/高德地图指南.PNG)
...
![高德验证成功](/img/dataease-v2/system_management/高德验证成功.PNG)

![高德创建应用](/img/dataease-v2/system_management/高德创建应用.png)

![高德添加KEY](/img/dataease-v2/system_management/高德添加KEY.png)
...
![配置KEY](/img/dataease-v2/system_management/配置KEY.png)
...
![MySQL设置](/img/dataease-v2/system_management/引擎管理.png)
