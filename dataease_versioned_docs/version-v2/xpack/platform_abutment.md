...
:::
![对接企业微信](/img/dataease-v2/xpack/平台对接扫码登录.png)
...
![对接企业微信](/img/dataease-v2/xpack/对接企业微信1.png)
...
![对接企业微信](/img/dataease-v2/xpack/对接企业微信2.png)
...
![对接企业微信](/img/dataease-v2/xpack/对接企业微信3.png)
...
![对接企业微信](/img/dataease-v2/xpack/对接企业微信4.png)
...
![对接企业微信](/img/dataease-v2/xpack/对接企业微信5.png)
...
:::
![对接企业微信](/img/dataease-v2/xpack/企业微信网页授权.png)

![对接企业微信](/img/dataease-v2/xpack/企业微信可信域名认证.png)
...
![对接企业微信](/img/dataease-v2/xpack/对接企业微信6.png)

![对接企业微信](/img/dataease-v2/xpack/对接企业微信7.png)
...
![对接企业微信](/img/dataease-v2/xpack/对接企业微信9.png)
...
![对接企业微信](/img/dataease-v2/xpack/对接企业微信8.png)
...
![对接企业微信](/img/dataease-v2/xpack/企业微信校验成功.png)
...
![对接企业微信](/img/dataease-v2/xpack/企业微信应用界面.png)
## 2 钉钉设置
### 2.1 配置平台对接信息
:::note
...
![对接钉钉平台](/img/dataease-v2/xpack/填写应用名称.png)
...
![对接钉钉平台](/img/dataease-v2/xpack/钉钉应用信息.png)
...
![对接钉钉平台](/img/dataease-v2/xpack/钉钉分享设置.png)
...
![对接钉钉平台](/img/dataease-v2/xpack/钉钉安全设置.png)
...
![对接钉钉平台](/img/dataease-v2/xpack/钉钉平台权限开通.png)
...
![对接钉钉平台](/img/dataease-v2/xpack/钉钉校验成功.png)
...
![对接钉钉平台](/img/dataease-v2/xpack/钉钉免密.png)

![对接钉钉平台](/img/dataease-v2/xpack/钉钉应用内部界面.png)
...
![对接飞书平台](/img/dataease-v2/xpack/飞书对接1.png)

![对接飞书平台](/img/dataease-v2/xpack/飞书对接2.png)

![对接飞书平台](/img/dataease-v2/xpack/飞书对接3.png)
...
![对接飞书平台](/img/dataease-v2/xpack/飞书对接4.png)
...
![对接飞书平台](/img/dataease-v2/xpack/飞书对接5.png)

:::note

新建 App，添加网页应用，设置桌面端主页为 DataEase 服务器地址。如果是 IP 地址，则填入 http(s)://域名/。
:::
![对接飞书平台](/img/dataease-v2/xpack/添加网页应用能力.png)

![对接飞书平台](/img/dataease-v2/xpack/v2飞书对接29.png)
...
![对接飞书平台](/img/dataease-v2/xpack/飞书回调域名配置.png)

:::note

应用授权，在应用的【权限管理】里进行应用的相关授权，具体权限参考下图：
:::
![对接飞书平台](/img/dataease-v2/xpack/v2飞书对接权限.png)
...
![对接飞书平台](/img/dataease-v2/xpack/飞书对接11.png)

![对接飞书平台](/img/dataease-v2/xpack/飞书对接12.png)
...
![对接飞书平台](/img/dataease-v2/xpack/飞书对接13.png)
...
![对接飞书平台](/img/dataease-v2/xpack/飞书对接14.png)
...
![对接飞书平台](/img/dataease-v2/xpack/v2飞书对接1%20(4).png)

![对接飞书平台](/img/dataease-v2/xpack/v2飞书对接1%20(3).png)

![对接飞书平台](/img/dataease-v2/xpack/v2飞书对接1%20(2).png)

:::note

平台对接发送定时报告和推送群组消息，需要另外开启机器人能力，以及开通“获取与上传图片或文件资源”以及获取群组的权限。
:::
![对接飞书平台](/img/dataease-v2/xpack/添加机器人.png)

![对接飞书平台](/img/dataease-v2/xpack/定时报告数据权限.png)

![对接飞书平台](/img/dataease-v2/xpack/飞书群组相关权限.png)
...
![对接飞书平台](/img/dataease-v2/xpack/飞书免密登录.png)

![对接飞书平台](/img/dataease-v2/xpack/飞书应用内部界面.png)
...
![对接国际飞书平台](/img/dataease-v2/xpack/lark创建应用.png)
...
![对接国际飞书平台](/img/dataease-v2/xpack/lark创建新项目.png)
...
![对接国际飞书平台](/img/dataease-v2/xpack/lark应用信息.png)
...
![对接国际飞书平台](/img/dataease-v2/xpack/lark添加机器人.png)
...
![对接国际飞书平台](/img/dataease-v2/xpack/lark开通权限.png)
...
![对接国际飞书平台](/img/dataease-v2/xpack/发送群组机器人消息.png)
...
![对接国际飞书平台](/img/dataease-v2/xpack/lark发布新版本.png)
...
![对接国际飞书平台](/img/dataease-v2/xpack/lark调用成功.png)
