...
<div style={{textAlign:"center",color:"#8a8f99",fontSize:"13px",margin:"16px 0 8px"}}>表 1  MaxKB 环境变量说明</div>
...
<img style={{display:"block",margin:"16px auto",maxWidth:"100%"}} src="/img/maxkb/Skills/openclaw_ask.png" alt="图 3  向 OpenClaw 询问 列出 MaxKB 中现有智能体" />

<div style={{textAlign:"center",color:"#8a8f99",fontSize:"13px",margin:"6px 0 20px"}}>图 3  向 OpenClaw 询问 列出 MaxKB 中现有智能体</div>
...
<img style={{display:"block",margin:"16px auto",maxWidth:"100%"}} src="/img/maxkb/Skills/openclaw_ask1.png" alt="图 4  向 OpenClaw 询问 如何重置 MaxKB 管理员密码" />

<div style={{textAlign:"center",color:"#8a8f99",fontSize:"13px",margin:"6px 0 20px"}}>图 4  向 OpenClaw 询问 如何重置 MaxKB 管理员密码</div>

<img style={{display:"block",margin:"16px auto",maxWidth:"100%"}} src="/img/maxkb/Skills/openclaw_ask2.png" alt="图 5  OpenClaw 通过 MaxKB Skills 完成密码重置方案" />

<div style={{textAlign:"center",color:"#8a8f99",fontSize:"13px",margin:"6px 0 20px"}}>图 5  OpenClaw 通过 MaxKB Skills 完成密码重置方案</div>
