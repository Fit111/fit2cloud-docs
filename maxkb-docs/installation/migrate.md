...
<img style={{display:"block",margin:"16px auto",maxWidth:"100%"}} src="/img/maxkb/index/migrate_route.png" alt="图 1  MaxKB v1 到 v2 迁移路线" />

<div style={{textAlign:"center",color:"#8a8f99",fontSize:"13px",margin:"6px 0 20px"}}>图 1  MaxKB v1 到 v2 迁移路线</div>
...
<img style={{display:"block",margin:"16px auto",maxWidth:"100%"}} src="/img/maxkb/index/migrate_linux_export.png" alt="图 3  v1数据导出" />

<div style={{textAlign:"center",color:"#8a8f99",fontSize:"13px",margin:"6px 0 20px"}}>图 3  v1数据导出</div>
...
<img style={{display:"block",margin:"16px auto",maxWidth:"100%"}} src="/img/maxkb/index/migrate_linux_import.png" alt="图 4  Linux 导入数据" />

<div style={{textAlign:"center",color:"#8a8f99",fontSize:"13px",margin:"6px 0 20px"}}>图 4  Linux 导入数据</div>
...
<img style={{display:"block",margin:"16px auto",maxWidth:"100%"}} src="/img/maxkb/index/migrate_windows_export.png" alt="图 6  Windows 导出数据" />

<div style={{textAlign:"center",color:"#8a8f99",fontSize:"13px",margin:"6px 0 20px"}}>图 6  Windows 导出数据</div>
