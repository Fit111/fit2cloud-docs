...
![AI 编程接入 1Panel AI 网关示意图](/img/1panel/ai/ai_coding_gateway.svg)
<div style={{textAlign:"center",color:"#8a8f99",fontSize:"13px",margin:"6px 0 20px"}}>图 1 AI 编程工具如何接入 1Panel AI 网关？界面</div>
