...
- **可访问互联网**
- 如果是内网环境，推荐使用 [离线安装](./enterprise-installation) 方式进行部署
...
<div style={{textAlign:"center",color:"#8a8f99",fontSize:"13px",margin:"16px 0 8px"}}>表 1 非交互安装环境变量参数说明</div>
...
安装成功后，可使用 [1pctl](./cli) 命令行工具来维护 1Panel
