...
- **产品价格**：离线版 ￥99 / 次下载，当前优惠价 ￥49 / 次下载
- **购买链接**：[https://jsj.top/f/sbCqY6](https://jsj.top/f/sbCqY6)
...
安装完成后，可使用 [1pctl 命令行工具](./cli) 进行日常维护。
...
<div style={{textAlign:"center",color:"#8a8f99",fontSize:"13px",margin:"16px 0 8px"}}>表 1 应用安装方式对比</div>
