---
title: Deploy JumpServer with 1Panel
---

## 1. Install 1Panel
:::note

- For 1Panel installation, deployment and basic feature introduction, please refer to [1Panel Official Documentation](/1panel/installation/online-installation).
...
:::note[Detailed parameter description:]
...
:::note[If the following log records appear, TASK-END indicates installation is complete.]

:::
![img](/img/jumpserver/V4_1panel_setup4.png)

## 4. Access JumpServer
:::note[After successful installation, access JumpServer through your browser.]
