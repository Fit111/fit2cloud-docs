---
title: Upgrade from Version 1.4.4 to 1.4.5
---
...
- Then upgrade to the latest version according to the [upgrade documentation](../upgrade_notice), otherwise normal use will not be possible.
:::
