...
:::note[Commands required for installation, refer to [Requirements](./requirements) for manual installation.]
...
&gt;  Please contact us for English version offline package download.
    ...
    :::note[After installation, the JumpServer configuration file path is: /opt/jumpserver/config/config.txt]
...
![Login Page](/img/jumpserver/online_install_01.png)
