---
title: 1Panel Installation
---

## 1. Install 1Panel
:::note

- For installation, deployment, and basic features of 1Panel, please refer to the [1Panel Official Documentation](/1panel/installation/online-installation).
- After completing the 1Panel installation, open your browser and navigate to the 1Panel URL as prompted, as shown below.
:::

![1Panel Page](/img/jumpserver/1panel_install_01.png)
...
![Install MySQL Database_01](/img/jumpserver/1panel_install_02.png)

![Install MySQL Database_02](/img/jumpserver/1panel_install_03.png)
...
![Install Redis Database](/img/jumpserver/1panel_install_04.png)
...
![Database Status Check](/img/jumpserver/1panel_install_05.png)
...
![Install JumpServer](/img/jumpserver/1panel_install_06.png)
...
![Install JumpServer](/img/jumpserver/1panel_install_07.png)
...
![Check JumpServer](/img/jumpserver/1panel_install_08.png)

## 4. Access JumpServer 
:::note[After successful installation, log in to JumpServer through a browser.]
...
![Access JumpServer](/img/jumpserver/1panel_install_09.png)
