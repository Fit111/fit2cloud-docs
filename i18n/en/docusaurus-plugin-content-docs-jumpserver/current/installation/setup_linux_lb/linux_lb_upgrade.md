...
- Download the latest linux/amd64 offline package from the Fei Zhi Yun community [downloads page](https://community.fit2cloud.com/#/products/jumpserver/downloads), and upload it to the /opt directory of the deployment server.
:::
...
```sh
cd /opt
tar -xf jumpserver-offline-installer-v4.10.17-amd64.tar.gz
cd jumpserver-offline-installer-v4.10.17-amd64
```
```sh
