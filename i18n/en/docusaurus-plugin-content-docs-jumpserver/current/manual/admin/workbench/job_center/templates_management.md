...
:::
![v4_mode_manage_1](/img/jumpserver/v4_mode_manage_1.png)

## 1 Create Template

:::note[Using Playbook-type template as an example, demonstrating the workflow for creating users on target assets.]
...
:::
![v4_mode_manage_2](/img/jumpserver/v4_mode_manage_2.png)
...
:::
![v4_mode_manage_3](/img/jumpserver/v4_mode_manage_3.png)

:::note

- Click the `Workspace` tab to create a main.yml file, as shown below:
:::
![v4_mode_manage_4](/img/jumpserver/v4_mode_manage_4.png)
...
:::
![v4_mode_manage_5](/img/jumpserver/v4_mode_manage_5.png)
