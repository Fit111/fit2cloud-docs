...
- On the Web Terminal page, click the **File Explorer** button and select the **Connect** button to enter the file explorer module. For detailed explanation of file explorer, refer to the [File Explorer](file_explorer) section.
:::
...
:::note[Command-line Configuration]
