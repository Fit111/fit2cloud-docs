...
## 4 Account Storage
:::note[Note: Account storage is an Enterprise edition feature.]
...
:::note[Note: Virtual applications are an Enterprise edition feature.]
...
- For usage configuration, see [Virtual Applications Configuration](virtual_apps).
:::
