...
## 1 Overview
:::note[Note: Application management is a JumpServer Enterprise edition feature.]
...
- For API documentation, please refer to: [API documentation](/jumpserver/dev/rest_api)
:::
