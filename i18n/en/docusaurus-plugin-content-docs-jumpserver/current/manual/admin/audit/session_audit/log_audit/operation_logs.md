...
- Click **Log Audit &gt; Operation Logs** to open the **Operation Logs** page.
...
:::
![operation_logs_01](/img/jumpserver/v4_operation_logs_01.png)

:::note

- Auditors can view detailed changes of operation logs through the **View** button.
:::
![operation_logs_02](/img/jumpserver/v4_operation_logs_02.png)
