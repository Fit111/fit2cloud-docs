...
Before using Web-type assets, you must configure a remote application publisher. See [Remote Applications](../../system_settings/remote_apps) for detailed configuration.
:::
