...
![V4_assets_build_1](/img/jumpserver/V4_assets_tree_1.png)
...
![V4_assets_build_2](/img/jumpserver/V4_assets_tree_2.png)

## 3 Asset types
:::note[Note: Oracle, SQL Server, ClickHouse, Dameng, DB2 databases are JumpServer Enterprise edition features.]
...
:::
![alt text](/img/jumpserver/V4_assets_type_3.png)

:::note

- Network device types default to include General, Cisco, Huawei, and H3C.
:::
![V4_assets_build_4](/img/jumpserver/V4_assets_type_4.png)
...
:::
![V4_assets_build_5](/img/jumpserver/V4_assets_type_5.png)

:::note

- Cloud services default to include private cloud VMs and Kubernetes.
:::
![V4_assets_build_6](/img/jumpserver/V4_assets_type_6.png)

:::note

- Web type assets include website resources. For detailed Web asset configuration, see [Creating Web Assets](web_assets).
:::
![V4_assets_build_7](/img/jumpserver/V4_assets_type_7.png)
...
:::
![V4_assets_type_8](/img/jumpserver/V4_assets_type_8.png)
...
:::
![V4_assets_type_9](/img/jumpserver/V4_assets_type_9.png)
...
:::
![V4_assets_build_8](/img/jumpserver/V4_assets_build_8.png)
:::note
...
:::
![V4_assets_build_9](/img/jumpserver/V4_assets_build_9.png)

### 4.3 Cloud sync (x-pack)
:::note[Note: Cloud sync is a JumpServer Enterprise edition feature.]
...
![V4_assets_build_10](/img/jumpserver/V4_assets_build_10.png)
...
![V4_assets_build_11](/img/jumpserver/V4_assets_build_11.png)
...
![V4_assets_build_12](/img/jumpserver/V4_assets_build_12.png)
...
:::note[Cloud sync task auto-release behavior (feature in v4.10.4 and later)]
...
![V4_assets_build_15](/img/jumpserver/V4_assets_build_15.png)
...
:::
![V4_assets_build_16](/img/jumpserver/V4_assets_build_16.png)
...
![V4_assets_update_13](/img/jumpserver/V4_assets_update_13.png)
...
![V4_assets_finduser_1](/img/jumpserver/V4_assets_finduser_1.png)
