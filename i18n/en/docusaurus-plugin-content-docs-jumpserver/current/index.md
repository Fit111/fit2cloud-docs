...
## 3 Page Display
![Interface Display](/img/jumpserver/dashboard.png)
...
- JumpServer is a security product. Please follow [basic security recommendations](faq/security) for installation and deployment.
...
- [JumpServer Enterprise Edition](https://jumpserver.org/enterprise.html)
- [JumpServer Appliance](https://jumpserver.org/hardware.html)
:::
...
- [JumpServer Technical Whitepaper](https://whitepaper.jumpserver.org/)
- [JumpServer Knowledge Base](https://kb.fit2cloud.com/categories/jumpserver)
- [Teaching Videos](https://space.bilibili.com/510493147?spm_id_from=333.337.0.0)
:::
